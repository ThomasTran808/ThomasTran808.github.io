...
labels:
  ...
  - Automation
  - Image Recognition
summary: "An automated bot using AutoHotkey v2.0 that continuously searches for specific on-screen images and performs automated clicking sequences."
---

<img class="img-fluid" src="../img/imagebot-header.png">
